...
void test_heapsort()
{
    ...
    Heapsort(conscience_sorted, 13);
    assert(conscience_sorted[0].get_conscience() == "00001111");
    assert(conscience_sorted[12].get_conscience() == "11110000");
}
...
void test_radixsort()
{
    ...
    // Sorting by conscience number
    Radixsort(conscience_sorted, 0, 13);
    assert(conscience_sorted[0].get_conscience() == "00001111");
    assert(conscience_sorted[12].get_conscience() == "11110000");
}